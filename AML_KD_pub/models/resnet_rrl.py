...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, low_dim=128, in_channel=3, width=1, num_class=1000):
        ...
        self.fc_lowD = nn.Linear(self.base * 8 * block.expansion, low_dim)
        self.recon = nn.Linear(low_dim, self.base * 8 * block.expansion)
        # self.classifier = nn.Linear(self.base * 8 * block.expansion, num_class)
        self.classifier = nn.Linear(low_dim, num_class)
    ...
    def forward(self, x, do_recon=False,has_out=True):
